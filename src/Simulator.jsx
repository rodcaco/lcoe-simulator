...
export default function App() {
  ...
  const [tabOrder, setTabOrder] = useState(() => {
    ...
    const saved = localStorage.getItem("lcoe_tabOrder_v3");
    ...
    if (missing.length > 0) {
      ...
      localStorage.setItem("lcoe_tabOrder_v3", JSON.stringify(updated));
      return updated;
    }
    return parsed;
  });
