...
export default function App() {
  ...
  const [tabOrder, setTabOrder] = useState(() => {
    const defaultOrder = ["overview","solar-wind corr","thesis","breakdown","profiles","scenarios","tornado","sld","reliability","buildout"];
    const saved = localStorage.getItem("lcoe_tabOrder_v4");
    ...
    if (missing.length > 0) {
      ...
      localStorage.setItem("lcoe_tabOrder_v4", JSON.stringify(updated));
      return updated;
    }
    return parsed;
  });
